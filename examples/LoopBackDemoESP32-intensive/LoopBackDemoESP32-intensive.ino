...
static const byte MCP2515_MOSI = 32 ; // SDI input of MCP2515
static const byte MCP2515_MISO = 33 ; // SDO output of MCP2515
...
static const byte MCP2515_RESET = 28 ; // RESET input of MCP2515 (adapt to your design)
